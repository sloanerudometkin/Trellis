...
const completed: AnalysisRunResponse = {
  ...
  health_score: 40, health_score_delta: null, health_score_history: [{ analysis_id: 31, score: 40, completed_at: "2026-09-06T12:01:00Z" }], health_score_disclosure: "Organic only. SEM is excluded.",
  suggestions: [
